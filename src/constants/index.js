...
export const HERO_CONTENT = ' Hi, I’m Praveen Raj, a passionate software developer and data analyst specializing in full-stack development, machine learning, and data-driven decision-making. I’ve built cutting-edge applications that enhance efficiency and drive insights. With hands-on experience in Python, ReactJS, and AWS, I thrive on solving complex problems. Let’s build the future together!';
...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    company: "Energy Efficiency Center, Arizona State University",
    description: `Designed and developed the PIEE website (https://piee.eec.asu.edu), a MERN-stack application for industrial energy projects, improving search efficiency by 200x. Integrated secure user authentication with JWT and built real-time energy dashboards for clients to track energy usage and performance.`,
  ...
  },
  {
    ...
    technologies: ["LSTMs", "Deep Neural Networks", "Python", "Satellite Geospatial Data"],
  },
  {
    ...
    technologies: ["Python", "AI Optimization", "NP-Hard CSP", "Timetabling Algorithms"],
  },
  {
...
export const PROJECTS = [
  ...
  },
  {
    ...
    technologies: ["OpenCV", "PyTorch", "Transfer Learning", "Image Processing"],
