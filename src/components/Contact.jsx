            ...
            <div className="mb-4 mx-auto">
              <div className="mb-4">
                ...
                <input
                  ...
                  className="mt-1 block w-full px-3 py-2 border bg-gray-300 text-black rounded-md"
                />
              </div>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="mt-1 block w-full px-3 py-2 bg-gray-300 border text-black rounded-md"
                />
              </div>
              <div className="mb-4">
                ...
                <textarea
                  ...
                  className="mt-1 block w-full px-3 py-2 border bg-gray-300 rounded-md text-black"
                />
              </div>
              <button
                type="submit"
