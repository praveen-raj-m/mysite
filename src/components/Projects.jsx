                    ...
                    >
                      ...
                      >
                        ...
                        {/* Back Face */}
                          ...
                          <div className="absolute w-full h-full flex flex-col items-center justify-center backface-hidden rounded-lg p-6 transform rotate-y-180">
                          <h6 className="mb-2 text-xl lg:text-3xl font-semibold text-white">
                           Description
                           </h6>
                          <p className="text-md lg:text-2xl text-neutral-400 text-center">
                            {project.description}
                          </p>
                        </div>
                      </div>
